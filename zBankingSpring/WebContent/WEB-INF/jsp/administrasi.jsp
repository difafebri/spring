...
<title><spring:message code="admin.msg" text="default text" /></title>
</head>
<body>
	<div class="header">
	...
	<div style="padding-left: 20px; padding-top:100px;">
		<a href="gantibahasa" class="button glow-button"><spring:message code="gantibhs.msg" text="default text"/></a>
		<a href="gantipw" class="button glow-button"><spring:message code="gantipw.msg" text="default text"/></a>
	</div>
</body>
</html>