...
<title><spring:message code="tagihan.msg" text="default text" /></title>
</head>
<body>
<div class="header">
...
<div class="container">
	<table>
		<tr>
			<td colspan="2"><spring:message code="totaltagihan.msg" text="default text"/></td>
			<td>${tagihanBulanLalu.total_tagihan}</td>
		</tr>
		<tr>
			<td colspan="2"><spring:message code="min.msg" text="default text"/></td>
			<td>Rp 50000</td>
		</tr>
		<tr>
			<td colspan="2"><spring:message code="jth.msg" text="default text"/></td>
			<td>${tagihanBulanLalu.jatuh_tempo}</td>
		</tr>
	</table>
	<br/>
	<table>
		...
		<c:forEach var="trans" items="${listTranBulanLalu}">
			<tr>
	...
	<br/>
	<form:form method="post" action="tagihanDibayar" onsubmit="return check();">
		<table>
			<tr class="row">
				<td class="col-25"><form:label path="paid"><spring:message code="paidd.msg" text="default text"/></form:label></td>
				<td class="col-75"><input name="paid" id="paid" type="text"/></td>
			</tr>
			<tr><td><c:set var="val"><spring:message code="alert.msg"/></c:set>
			<input type="hidden" id="alert" value="${val}"/>
			</td></tr>
			<tr class="row">
...
<script>
function check(){
	if(document.getElementById('paid').value < 50000){
